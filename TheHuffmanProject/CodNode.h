...
public:
    ...
    CodNode(const E& value, const int& codification)
    {
        this->content = value;
...
//    CodNode(const E& value, const int& count, CodNode *ptr)
//    {
//        this->content = value;
//        //this->quantity = count;
//        //this->right = ptr;
